...
/// A compact, bit-packed representation of a FreeCell game state for fast hashing and equality.
#[derive(Clone, PartialEq, Eq, Hash)]
...
impl PackedState {
    /// Convert a GameState into a PackedState
...
fn pack_card(card: &crate::card::Card) -> u8 {
